...
var MELODY_SONGS = [    buildMelodySong('twinkle', '작은별', '도도솔솔라라솔-파파미미레레도-솔솔파파미미레-솔솔파파미미레-도도솔솔라라솔-파파미미레레도-'),
    ...
    buildMelodySong('Bubble', '방울방울', 'd도(8)도(8)도(8)도(4)d도(4)d미(8)d레(8)레(8)레(8)레(4)d레(4)d파(8)d미(8)미(8)미(8)미(8)미(8)도(4)레(4)-(8)d파(8)d솔(4)d레(4)-(8)d도(8)도(8)도(8)도(4)d도(4)d미(8)d레(8)레(8)레(8)레(4)d레(4)d파(8)d미(8)d파(8)d미(8)d미(8)d미(8)d레(4)d도(4)-(2)-(4)-(8)')
                   ];
